...
def test_create_full_url_already_full():
    assert create_full_url("", "https://example.org/") == "https://example.org/"
    assert create_full_url("", "https://example.org") == "https://example.org"
    assert create_full_url("", "http://example.org/") == "http://example.org/"
    assert create_full_url("", "http://example.org") == "http://example.org"
    assert create_full_url("", "https://example.org/foo") == "https://example.org/foo"
    assert (
