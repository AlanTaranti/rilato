...
class TestRilatoApplication:
    ...
    def test_do_activate_with_window(self, app) -> None:
        ...
        with patch('gi.repository.Gio.Application.props', new_callable=PropertyMock) as mock_props:
    ...
    def test_on_about_action(self, mock_about_dialog, app) -> None:
        ...
        with patch('gi.repository.Gio.Application.props', new_callable=PropertyMock) as mock_props:
            ...
            assert mock_about_dialog.call_args[1]['application_icon'] == 'me.alantaranti.rilato'
