...
from rilato.articles_listview import ArticlesListView, ArticlesListBox
...
class RilatoSidebar(Gtk.Overlay):
    __gtype_name__ = "RilatoSidebar"
    ...
    def __init__(self):
        ...
        self.feedman.connect("feedmanager_refresh_start", self.on_refresh_start)
        self.feedman.connect("feedmanager_refresh_end", self.on_refresh_end)
        self.feedman.connect(
            "feedmanager_feeds_loaded_changed", self.on_feeds_loaded_changed
        )
