...
from rilato.filter_view import FilterView
from rilato.feed_item import FeedItem
from rilato.stack_with_empty_state import StackWithEmptyState
from operator import or_
from subprocess import Popen
from gi.repository import GObject, Gtk, Adw, Gio
from rilato.sidebar import RilatoSidebar
from rilato.webview import RilatoWebView
from rilato.headerbar import LeftHeaderbar, RightHeaderbar
...
class MainLeaflet(Adw.Bin):
    ...
    sidebar: RilatoSidebar = Gtk.Template.Child()
    webview: RilatoWebView = Gtk.Template.Child()
